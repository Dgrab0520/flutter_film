class Order_ProList{
  ...
  Order_ProList({required this.order_id, required this.user_id, required this.pro_id, required this.estimate_date, required this.estimate_detail, required this.skill, required this.com_name, required this.area1, required this.profile_img});

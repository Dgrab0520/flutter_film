class Pro_Point {
  ...
  factory Pro_Point.fromJson(Map<String, dynamic> json) {
    return Pro_Point(
      ...
      point_info:
          json['point_info'] == null ? "" : json['point_info'] as String,
      point_detail:
          json['point_detail'] == null ? "" : json['point_detail'] as String,
      total_point:
          json['total_point'] == null ? "" : json['total_point'] as String,

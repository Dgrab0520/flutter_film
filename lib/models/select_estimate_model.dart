class Select_Estimate{
  ...
  Select_Estimate({required this.order_id, required this.estimate_id, required this.user_id, required this.pro_id, required this.estimate_detail, required this.count});

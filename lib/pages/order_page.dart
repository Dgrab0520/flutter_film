...
class _OrderPageState extends State<OrderPage>{
  ...
  final _valueList3 = ["선택","수도권", "부산", "대구", "광주", "대전", "울산", "세종", "강원", "경남", "경북", "전남", "전북", "충남", "충북", "제주"];
  ...
  void sendFCM() async {
    ...
    final HttpsCallableResult result = await callable.call(
      ...
      Get.snackbar('전송완료', '전문가에게 전송이 완료되었습니다',)
    );
    print(result.data);
  }
            ...
            children: <Widget>[
              ...
              SizedBox(
                ...
                ElevatedButton(
                  ...
                  onPressed: (){
                    print('신청하기');
                    if(_selectedValue1 != '선택' || _selectedValue2 != '선택' || _selectedValue3 != '선택'){
                      _addOrder();
                    }else{

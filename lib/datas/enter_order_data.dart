...
class Order_Data{
  ...
  static Future<String> addOrder(String user_id, String order_id, String service_date, String service_area, String service_type, String service_size, String service_detail, String order_type, String dir_pro_id) async{
    try{

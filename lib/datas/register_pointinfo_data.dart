...
class Register_PointInfo {
  static const ROOT = "http://211.110.1.58/film_register_pointinfo.php";
  static const _ADD_POINITINFO_ACTION = "ADD_POINTINFO";

  static Future<String> addPointInfo(
      String user_id, String point_info, String point_detail) async {
    try {
